<form class="form-horizontal" action="{{ route('passport.store') }}" method="POST" autocomplete="off" id="create-form"
    ...
    <div class="form-group">
        ...
        <div class="col-md-8">
            <input type="text" class="form-control" name="passport_cost" value="{{ old('passport_cost') }}">
            @error('passport_cost')
                <div class="form-control-feedback">
                    {{ $message }}
                </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-8">
            <input type="text" class="form-control" name="car_charges" value="{{ old('car_charges') }}">
            @error('car_charges')
                <div class="form-control-feedback">
                    {{ $message }}
                </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-8">
            <input type="text" class="form-control" name="deposit" value="0">
            @error('deposit')
                <div class="form-control-feedback">
                    {{ $message }}
                </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-8">
            <input type="text" class="form-control" name="go_date" placeholder="">
            @error('go_date')
                <div class="form-control-feedback">
                    {{ $message }}
                </div>
