        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-success">
                    <div class="box-body">
                        <div class="col-md-8">
                            <form action="{{ route('accountclassification.update', $account_classifications->id) }}"
                                ...
                                <div class="form-group" style="padding: 17px;">
                                    ...
                                    <div class="col-md-9">
                                        <input class="form-control @error('account_name') is-invalid @enderror"
                                            ...
                                            value="{{ $account_classifications->name }}" />
                                        @error('account_name')
                                ...
                                <div class="form-group" style="padding: 17px;">
                                    ...
                                    <div class="col-md-9">
                                        <input class="form-control @error('account_code') is-invalid @enderror"
                                            ...
                                            value="{{ $account_classifications->ac_code }}" />
                                        @error('account_code')
                                            <div class="invalid-feedback"> {{ $message }} </div>
                                        @enderror
                                    </div>
...
@endsection
@section('script')
    {!! JsValidator::formRequest('App\Http\Requests\UpdateAccountClassification', '#create-form') !!}
@endsection
