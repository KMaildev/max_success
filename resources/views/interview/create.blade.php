<form class="form-horizontal" action="{{ route('interview.store') }}" method="POST" autocomplete="off" id="create-form"
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="general">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <select style="width: 100%;" class="form-control form-select select2" name="demand_id"
                                id="demandId">
                                <option value="0">
